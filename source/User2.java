...
class client2 extends JFrame implements ActionListener, Runnable {
    ...
    client2(String s) {
        ...
        myadapter2 a = new myadapter2(this);
        addWindowListener(a);
            ...
            if (str.equals("Connect")) {
                try {
                    ...
                    if (!inputName.getText().equals("")) {
                        ...
                        msg.clientPort.put(inputName.getText(), 2002);
                        obj.writeObject(msg);
    ...
    public void getServer() {
		try {
			...
			while (true) {
                ...
                new newclientthread2(clientSocket, msg, record, count, this, serverSocket);
				}
			} catch(Exception e){
				try {
					serverSocket.close();
...
class newclientthread2 implements Runnable {
	Thread t2;
	Socket client;
	Message msg;
	data flag;
	...
	newclientthread2(Socket client, Message msg, data flag, Socket count[], client2 f, ServerSocket server) {
		t2 = new Thread(this, "ClientSocket2");
		this.server = server;
		this.client = client;
		this.msg = msg;
		this.f = f;

...
class client1 extends JFrame implements ActionListener, Runnable {
    ...
    client1(String s) {
        ...
        myadapter1 a = new myadapter1(this);
        addWindowListener(a);
            ...
            if (str.equals("Connect")) {
                try {
                    ...
                    if (!inputName.getText().equals("")) {
                            ...
                            msg.clientPort.put(inputName.getText(), 2001);
                            obj.writeObject(msg);
    ...
    public void getServer() {
        try {
			...
			while (true) {
                ...
                new newclientthread1(clientSocket, msg, record, count, this, serverSocket);
				}
			} catch(Exception e){
				try {
					serverSocket.close();
...
class newclientthread1 implements Runnable {
	Thread t1;
	Socket client;
	Message msg;
	data flag;
	...
	newclientthread1(Socket client, Message msg, data flag, Socket count[], client1 f, ServerSocket server) {
		t1 = new Thread(this, "ClientSocket1");
		this.server = server;
		this.client = client;
		this.msg = msg;
		this.f = f;

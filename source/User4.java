...
class client4 extends JFrame implements ActionListener, Runnable {
    ...
    client4(String s) {
        ...
        myadapter4 a = new myadapter4(this);
        addWindowListener(a);
            ...
            if (str.equals("Connect")) {
                try {
                    ...
                    if (!inputName.getText().equals("")) {
                        ...
                        msg.clientPort.put(inputName.getText(), 2004);
                        obj.writeObject(msg);
                        ...
                        user4 = new Thread(this, "Reading1");
                        user4.start();
                    }
                } catch (Exception e) {
    ...
    public void getServer() {
        try {
			...
			while (true) {
                ...
                new newclientthread4(clientSocket, msg, record, count, this, serverSocket);
				}
			} catch(Exception e){
				try {
					serverSocket.close();
...
class myadapter4 extends WindowAdapter {
    client4 f;

    public myadapter4(client4 j) {
        f = j;
    }
...
class newclientthread4 implements Runnable {
	Thread t4;
	Socket client;
	Message msg;
	data flag;
	...
	newclientthread4(Socket client, Message msg, data flag, Socket count[], client4 f, ServerSocket server) {
		t4 = new Thread(this, "ClientSocket4");
		this.server = server;
		this.client = client;
		this.msg = msg;
		this.f = f;

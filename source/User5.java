...
class client5 extends JFrame implements ActionListener, Runnable {
    ...
    client5(String s) {
        ...
        myadapter5 a = new myadapter5(this);
        addWindowListener(a);
            ...
            if (str.equals("Connect")) {
                try {
                    ...
                    if (!inputName.getText().equals("")) {
                        ...
                        msg.clientPort.put(inputName.getText(), 2005);
                        obj.writeObject(msg);
                        ...
                        user5 = new Thread(this, "Reading1");
                        user5.start();
                    }
                } catch (Exception e) {
    ...
    public void getServer() {
        try {
			...
			while (true) {
                ...
                new newclientthread5(clientSocket, msg, record, count, this, serverSocket);
				}
			} catch(Exception e){
				try {
					serverSocket.close();
...
class myadapter5 extends WindowAdapter {
    client5 f;

    public myadapter5(client5 j) {
        f = j;
    }
...
class newclientthread5 implements Runnable {
	Thread t5;
	Socket client;
	Message msg;
	data flag;
	...
	newclientthread5(Socket client, Message msg, data flag, Socket count[], client5 f, ServerSocket server) {
		t5 = new Thread(this, "ClientSocket5");
		this.server = server;
		this.client = client;
		this.msg = msg;
		this.f = f;
